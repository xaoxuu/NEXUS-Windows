Class MainWindow
    ...
    Private Sub window_Initialized(sender As Object, e As EventArgs) Handles NEXUS_Search.Initialized
        ...
        If Dir("C:\Program Files\NEXUS\VBS\NEXUS_Search_Open.vbs") = "" Then '
        Else '
            WshShell.Run(Chr(34) & "C:\Program Files\NEXUS\VBS\NEXUS_Search_Open.vbs" & Chr(34))
        End If
        Input.Focus()
    End Sub
    '↑↑↑初始化
    ...
    Private Sub MainWindow_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        If Dir("C:\Program Files\NEXUS\VBS\NEXUS_Search_Close.vbs") = "" Then '
        Else '
    ...
    Private Sub Button_Expand_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button_Expand.MouseEnter
        ...
        Button_Cancel.Visibility = Windows.Visibility.Collapsed

        Button_OK.Visibility = Windows.Visibility.Collapsed


        If Dir("D:\Program Files\NEXUS\Temp\NEXUS_Runing.dll") = "" Then
            Fun_Tips("现在点击鼠标左键打开NEXUS主程序。")
        Else
            Fun_Tips("现在点击鼠标左键关闭NEXUS主程序。")
        End If
    ...
    Private Sub Button_Search_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button_Search.MouseEnter
        Dim i As String
        If Input.Text = "" Then
            If Button_Cancel.Visibility = Windows.Visibility.Visible Then
            Else
                Fun_Tips("现在点击鼠标左键打开百度主页。")
            End If


        Else
            i = "现在点击鼠标左键使用百度搜索【" + Input.Text + "】"
            Fun_Tips(i)
        End If
    End Sub
    '↑↑↑鼠标进入搜索按钮
    ...
    Private Sub Fun_Enter()
        ...
        If Inputs = "help" Or Inputs = "帮助" Or Inputs = "使用说明" Then
            'help
    ...
    Private Sub Fun_Tips(i As String)
        ...
        ElseIf i = "1" Then
            ...
            Input.Visibility = Windows.Visibility.Hidden
        Else
    ...
    Private Sub Fun_Launch()
        Dim i, j As String
        i = Input.Text + ".lnk"
        j = "D:\Program Files\NEXUS\Launcher\" + i
        If Dir(j) = "" Then
    ...
    Private Sub Button_Expand_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button_Expand.MouseDown
        If Dir("D:\Program Files\NEXUS\Temp\NEXUS_Runing.dll") = "" Then
            ...
            Fun_Tips("现在点击鼠标左键关闭NEXUS主程序。")
        Else
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\VBS\NEXUS_Close.vbs" & Chr(34))
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\VBS\NEXUS_Kill.vbs" & Chr(34))
            Fun_Tips("现在点击鼠标左键打开NEXUS主程序。")
        End If
    End Sub
    '↑↑↑Expand按钮
    ...
    Private Sub Input_MouseEnter(sender As Object, e As MouseEventArgs) Handles Input.MouseEnter
    ...
    Private Sub Input_TextChanged(sender As Object, e As TextChangedEventArgs) Handles Input.TextChanged
        ...
        Fun_Launch()
        '■■■■■■■■■■■■■■■■■■■■■■■■■■■■■基本组件和服务
        If Inputs = "help" Or Inputs = "帮助" Then 'help
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Expand\NEXUS_Instructions.exe" & Chr(34))
            Fun_Clear()
        ElseIf Inputs = "定时关机" Or Inputs = "dsgj" Then '定时关机
            Fun_Tips("1")
            Fun_Tips("请在左方输入时间（纯数字），更详细的使用细节请在设置栏里找。")
            Button_Cancel.Visibility = Windows.Visibility.Visible
            Button_OK.Visibility = Windows.Visibility.Visible
            Button_Cancel.Text = "取消"
            Button_OK.Text = "确定"

            Fun_Clear()

            ' ElseIf Inputs = "游戏管家" Or Inputs = "精灵游戏管家" Then 'help
            '    WshShell.run(Chr(34) & "Expand\NEXUS_Expand_XLauncher.exe" & Chr(34))
            '     Fun_Clear()
            ' ElseIf Inputs = "考研助手" Or Inputs = "精灵考研助手" Then 'help
            '     WshShell.run(Chr(34) & "Expand\NEXUS_Expand_GREAssistant.exe" & Chr(34))
            '      Fun_Clear()
            '  ElseIf Inputs = "软件助手" Or Inputs = "精灵软件助手" Then 'help
            '     WshShell.run(Chr(34) & "Expand\NEXUS_Expand_SoftwareAssistant.exe" & Chr(34))
            '     Fun_Clear()

        ElseIf Inputs = "end" Then '隐藏
            End

        ElseIf Input.Text = "X-FILES" Then '隐藏

            Address = (Chr(34) & "D:\X-Files\" & Chr(34))
            Fun_Run(Address)

        ElseIf Input.Text = "BROMANCE" Then '隐藏
        ...
        ElseIf Inputs = "kuand" Or Inputs = "路由器" Or Inputs = "luyouq" Or Inputs = "宽带" Then '宽带
            ...
            Fun_Run(Address)
        ElseIf Inputs = "更新" Or Inputs = "gengx" Or Inputs = "gengxin" Then '更新
            Address = ("https://TitanStudio.github.io/NEXUS")
            Fun_Run(Address)
        ElseIf Inputs = "反馈" Or Inputs = "fankui" Or Inputs = "fanku" Or Inputs = "建议" Or Inputs = "意见" Then '反馈
            Address = ("https://github.com/TitanStudio/NEXUS/issues/1")
            Fun_Run(Address)
        ...
        ElseIf Inputs = "ssssssssss" Then
            WshShell.run(Chr(34) & "VBS\shutdown-s.vbs" & Chr(34))
            End
        ElseIf Inputs = "hhhhhhhhhh" Then
            Address = ("shutdown -h")
            Fun_Run(Address)
        ElseIf Inputs = "llllllllll" Then
            WshShell.run(Chr(34) & "VBS\shutdown-l.vbs" & Chr(34))
            End
        ElseIf Inputs = "rrrrrrrrrr" Then
            WshShell.run(Chr(34) & "VBS\shutdown-r.vbs" & Chr(34))
            End
            '■■■■■■■■■■■■■■■■■■■■■■■■■■■学生周边
        ...
        ElseIf Inputs = "贴吧" Or Inputs = "百度贴吧" Then
            ...
            Fun_Run(Address)
        ElseIf Inputs = "音乐" Or Inputs = "网易云音乐" Then
            Address = ("http://music.163.com/")
            Fun_Run(Address)
        ...
        ElseIf Inputs = "qq空间" Or Inputs = "qzone" Then
            ...
            Fun_Run(Address)
        ElseIf Inputs = "webqq" Or Inputs = "网页qq" Then
        ...
        ElseIf Inputs = "macx" Then
            Address = ("http://www.macx.cn/")
            Fun_Run(Address)
        ...
        ElseIf Inputs = "硕鼠" Or Inputs = "硕鼠网" Or Inputs = "flvcd" Then
            ...
            '■■■■■■■■■■■■■■■■■■■■■■■■■■■快捷下载
            '===========================聊天通讯===========================
        ElseIf Inputs = "下载qq" Then
            Address = ("http://im.qq.com/download/")
            Fun_Run(Address)
        ElseIf Inputs = "下载阿里旺旺" Or Inputs = "下载旺旺" Then
            ...
            Fun_Run(Address)
        ElseIf Inputs = "下载tm" Or Inputs = "下载tm201" Then
    ...
    Private Sub TimeBox_MouseEnter(sender As Object, e As MouseEventArgs) Handles TimeBox.MouseEnter
        TimeBox.Focus()
