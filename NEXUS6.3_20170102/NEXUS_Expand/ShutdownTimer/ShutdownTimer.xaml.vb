Class MainWindow
    ...
    Private Sub 标题_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs) Handles 标题.MouseLeftButtonDown
        NEXUS_ShutdownTimer.Opacity = 0.8
        NEXUS_ShutdownTimer.DragMove()
        NEXUS_ShutdownTimer.Opacity = 1
    End Sub

    Private Sub NEXUS_Tips_Version_MouseEnter(sender As Object, e As MouseEventArgs) Handles NEXUS_ShutdownTimer.MouseEnter
    ...
    Private Sub NEXUS_Tips_Version_MouseLeave(sender As Object, e As MouseEventArgs) Handles NEXUS_ShutdownTimer.MouseLeave
