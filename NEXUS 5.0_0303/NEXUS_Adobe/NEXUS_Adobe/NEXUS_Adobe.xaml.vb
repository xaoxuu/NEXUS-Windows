Class MainWindow
    ...
    '↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓鼠标移动特效↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    '------------------------------鼠标进入
    Private Sub Adobe软件助手_MouseEnter(sender As Object, e As MouseEventArgs) Handles Adobe软件助手.MouseEnter
        图文窗口.Visibility = Windows.Visibility.Visible

    End Sub

    '------------------------------鼠标离开
    Private Sub Adobe软件助手_MouseLeave(sender As Object, e As MouseEventArgs) Handles Adobe软件助手.MouseLeave
    ...
    '↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑点击按钮↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    Private Sub NEXUS_Adobe_MouseEnter(sender As Object, e As MouseEventArgs) Handles NEXUS_Adobe.MouseEnter
    ...
    Private Sub NEXUS_Adobe_MouseLeave(sender As Object, e As MouseEventArgs) Handles NEXUS_Adobe.MouseLeave
    ...
    Private Sub NEXUS_Adobe_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs) Handles NEXUS_Adobe.MouseLeftButtonDown
        NEXUS_Adobe.Opacity = 0.85
        NEXUS_Adobe.DragMove()
        NEXUS_Adobe.Opacity = 1
    End Sub
    ...
    Private Sub 标题按钮2_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 标题按钮2.MouseDown
        NEXUS_Adobe.WindowState = Windows.WindowState.Minimized
    End Sub
