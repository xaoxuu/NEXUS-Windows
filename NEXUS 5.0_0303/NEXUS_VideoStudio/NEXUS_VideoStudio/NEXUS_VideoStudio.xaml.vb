Class MainWindow
    ...
    '↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓鼠标移动特效↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    '------------------------------鼠标进入
    Private Sub Corel软件助手_MouseEnter(sender As Object, e As MouseEventArgs) Handles Corel软件助手.MouseEnter
        图文窗口.Visibility = Windows.Visibility.Visible

    End Sub

    '------------------------------鼠标离开
    Private Sub Corel软件助手_MouseLeave(sender As Object, e As MouseEventArgs) Handles Corel软件助手.MouseLeave
    ...
    Private Sub NEXUS_VideoStudio_MouseEnter(sender As Object, e As MouseEventArgs) Handles NEXUS_VideoStudio.MouseEnter
    ...
    Private Sub NEXUS_VideoStudio_MouseLeave(sender As Object, e As MouseEventArgs) Handles NEXUS_VideoStudio.MouseLeave
    ...
    Private Sub NEXUS_VideoStudio_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs) Handles NEXUS_VideoStudio.MouseLeftButtonDown
        NEXUS_VideoStudio.Opacity = 0.85
        NEXUS_VideoStudio.DragMove()
        NEXUS_VideoStudio.Opacity = 1
    End Sub
    ...
    Private Sub 标题按钮2_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 标题按钮2.MouseDown
        NEXUS_VideoStudio.WindowState = Windows.WindowState.Minimized
    End Sub
