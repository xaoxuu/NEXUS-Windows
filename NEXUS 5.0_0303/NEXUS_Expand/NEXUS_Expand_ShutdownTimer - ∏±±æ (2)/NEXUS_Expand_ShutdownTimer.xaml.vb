Class MainWindow
    ...
    Private Sub MainWindow_Initialized(sender As Object, e As EventArgs) Handles Me.Initialized
        取消定时关机.Visibility = Windows.Visibility.Collapsed
    End Sub
    ...
    Private Sub Button_确定_Click(sender As Object, e As RoutedEventArgs) Handles Button_确定.Click
        子函数_定时关机("执行")
        开关1_开.Visibility = Windows.Visibility.Visible
        开关1_关.Visibility = Windows.Visibility.Hidden
    End Sub


    Private Sub 开关1_关_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 开关1_关.MouseDown
        子函数_定时关机("执行")
        开关1_开.Visibility = Windows.Visibility.Visible
        开关1_关.Visibility = Windows.Visibility.Hidden
    End Sub

    Private Sub 开关1_开_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 开关1_开.MouseDown
        子函数_定时关机("取消")
        开关1_开.Visibility = Windows.Visibility.Hidden
        开关1_关.Visibility = Windows.Visibility.Visible
    End Sub

    Private Sub 开关2_关_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 开关2_关.MouseDown
        子函数_定时关机("取消")
        开关2_开.Visibility = Windows.Visibility.Visible
        开关2_关.Visibility = Windows.Visibility.Hidden
    End Sub

    Private Sub 开关2_开_MouseUp(sender As Object, e As MouseButtonEventArgs) Handles 开关2_开.MouseUp
        开关1_开.Visibility = Windows.Visibility.Hidden
        开关1_关.Visibility = Windows.Visibility.Visible
        开关2_开.Visibility = Windows.Visibility.Hidden
        开关2_关.Visibility = Windows.Visibility.Visible
    End Sub


    Private Sub 标题_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs) Handles 标题.MouseLeftButtonDown
        NEXUS_Expand_ShutdownTimer.Opacity = 0.85
        NEXUS_Expand_ShutdownTimer.DragMove()
        NEXUS_Expand_ShutdownTimer.Opacity = 1
    End Sub

    Private Sub NEXUS_Tips_Version_MouseEnter(sender As Object, e As MouseEventArgs) Handles NEXUS_Expand_ShutdownTimer.MouseEnter
    ...
    Private Sub NEXUS_Tips_Version_MouseLeave(sender As Object, e As MouseEventArgs) Handles NEXUS_Expand_ShutdownTimer.MouseLeave
    ...
    Private Sub 上半部_MouseEnter(sender As Object, e As MouseEventArgs) Handles 上半部.MouseEnter
        取消定时关机.Visibility = Windows.Visibility.Visible
    End Sub
