Class MainWindow
    ...
    '↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓鼠标移动特效↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    '------------------------------鼠标进入
    Private Sub Office软件助手_MouseEnter(sender As Object, e As MouseEventArgs) Handles Office软件助手.MouseEnter
        图文窗口.Visibility = Windows.Visibility.Visible

    End Sub

    '------------------------------鼠标离开
    Private Sub Office软件助手_MouseLeave(sender As Object, e As MouseEventArgs) Handles Office软件助手.MouseLeave
    ...
    Private Sub Button_A21_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button_A21.MouseDown
        WshShell.run(Chr(34) & "D:\Program Files\NEXUS\Box\Class3\Office2013\Office2013安装教程.mht" & Chr(34))
        窗口切换("缩小")
    End Sub
    ...
    Private Sub NEXUS_Office_MouseEnter(sender As Object, e As MouseEventArgs) Handles NEXUS_Office.MouseEnter
    ...
    Private Sub NEXUS_Office_MouseLeave(sender As Object, e As MouseEventArgs) Handles NEXUS_Office.MouseLeave

        背景_灰色.Visibility = Windows.Visibility.Visible
        If Main.Visibility = Windows.Visibility.Visible Then
    ...
    Private Sub 迷你模式_MouseEnter(sender As Object, e As MouseEventArgs) Handles 迷你模式.MouseEnter
        迷你背景_灰色.Visibility = Windows.Visibility.Hidden
        迷你背景_蓝色.Visibility = Windows.Visibility.Visible
    End Sub

    Private Sub 迷你模式_MouseLeave(sender As Object, e As MouseEventArgs) Handles 迷你模式.MouseLeave
        迷你背景_灰色.Visibility = Windows.Visibility.Visible
        迷你背景_蓝色.Visibility = Windows.Visibility.Hidden
    End Sub
    ...
    Private Sub NEXUS_Office_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs) Handles NEXUS_Office.MouseLeftButtonDown
        NEXUS_Office.Opacity = 0.85
        NEXUS_Office.DragMove()
        NEXUS_Office.Opacity = 1
    End Sub



    Private Sub 标题按钮0_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 标题按钮0.MouseDown
        窗口切换("缩小")
    End Sub

    Private Sub 标题按钮0_MouseEnter(sender As Object, e As MouseEventArgs) Handles 标题按钮0.MouseEnter
        标题按钮0_Rectangle_1.Fill = New SolidColorBrush(Color.FromRgb(60, 153, 248))
        标题按钮0_Rectangle_2.Fill = New SolidColorBrush(Color.FromRgb(60, 153, 248))

    End Sub

    Private Sub 标题按钮0_MouseLeave(sender As Object, e As MouseEventArgs) Handles 标题按钮0.MouseLeave
        标题按钮0_Rectangle_1.Fill = New SolidColorBrush(Color.FromRgb(180, 180, 180))
        标题按钮0_Rectangle_2.Fill = New SolidColorBrush(Color.FromRgb(180, 180, 180))
    ...
    Private Sub 标题按钮2_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 标题按钮2.MouseDown
        NEXUS_Office.WindowState = Windows.WindowState.Minimized
    End Sub
