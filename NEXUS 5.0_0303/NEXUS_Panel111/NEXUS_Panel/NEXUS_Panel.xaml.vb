Class MainWindow
    ...
    Private Sub Fun_Color(i As String)
        ButtonA1_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(245, 245, 245))
        ButtonA1_TextBox_1.Foreground = New SolidColorBrush(Color.FromRgb(0, 80, 239))
        ButtonA1_TextBox_2.Foreground = New SolidColorBrush(Color.FromRgb(0, 80, 239))
        ButtonA2_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(245, 245, 245))
        ButtonA2_TextBox_1.Foreground = New SolidColorBrush(Color.FromRgb(235, 60, 0))
        ButtonA2_TextBox_2.Foreground = New SolidColorBrush(Color.FromRgb(235, 60, 0))
        ButtonA3_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(245, 245, 245))
        ButtonA3_TextBox_1.Foreground = New SolidColorBrush(Color.FromRgb(96, 169, 23))
        ButtonA3_TextBox_2.Foreground = New SolidColorBrush(Color.FromRgb(96, 169, 23))
        ButtonA4_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(245, 245, 245))
        ButtonA4_TextBox_1.Foreground = New SolidColorBrush(Color.FromRgb(250, 104, 0))
        ButtonA4_TextBox_2.Foreground = New SolidColorBrush(Color.FromRgb(250, 104, 0))
        ButtonA5_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(245, 245, 245))
        ButtonA5_TextBox_1.Foreground = New SolidColorBrush(Color.FromRgb(164, 196, 0))
        ButtonA5_TextBox_2.Foreground = New SolidColorBrush(Color.FromRgb(164, 196, 0))
        ButtonA6_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(245, 245, 245))
        ButtonA6_TextBox_1.Foreground = New SolidColorBrush(Color.FromRgb(227, 200, 0))
        ButtonA6_TextBox_2.Foreground = New SolidColorBrush(Color.FromRgb(227, 200, 0))
        ButtonB11_Rectangle_.Opacity = 0
        ButtonB12_Rectangle_.Opacity = 0
        ButtonB21_Rectangle_.Opacity = 0
        ButtonB22_Rectangle_.Opacity = 0
        ButtonB23_Rectangle_.Opacity = 0
        ButtonB31_Rectangle_.Opacity = 0
        ButtonB32_Rectangle_.Opacity = 0
        ButtonB33_Rectangle_.Opacity = 0
        ButtonB34_Rectangle_.Opacity = 0
        If i = "0" Then
        ...
        ElseIf i = "a1" Then
            ButtonA1_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(0, 80, 239))
        ...
        ElseIf i = "a2" Then
            ButtonA2_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(235, 60, 0))
        ...
        ElseIf i = "a3" Then
            ButtonA3_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(96, 169, 23))
        ...
        ElseIf i = "a4" Then
            ButtonA4_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(250, 104, 0))
        ...
        ElseIf i = "a5" Then
            ButtonA5_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(164, 196, 0))
        ...
        ElseIf i = "a6" Then
            ButtonA6_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(227, 200, 0))
    ...
    Private Sub TitleButton1_MouseEnter(sender As Object, e As MouseEventArgs) Handles TitleButton1.MouseEnter
        TitleButton1_Rectangle_.Background = New SolidColorBrush(Color.FromRgb(51, 153, 255))
        Fun_TitleTips("反馈")
    End Sub
    ...
    Private Sub TitleButton2_MouseEnter(sender As Object, e As MouseEventArgs) Handles TitleButton2.MouseEnter
        TitleButton2_Rectangle_.Fill = New SolidColorBrush(Color.FromRgb(51, 153, 255))
        Fun_TitleTips("缩小")
    ...
    Private Sub TitleButton3_MouseEnter(sender As Object, e As MouseEventArgs) Handles TitleButton3.MouseEnter
        TitleButton3_Rectangle_1.Fill = New SolidColorBrush(Color.FromRgb(51, 153, 255))
        TitleButton3_Rectangle_2.Fill = New SolidColorBrush(Color.FromRgb(51, 153, 255))
        Fun_TitleTips("关闭")
    ...
    Private Sub ButtonB11_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB11.MouseEnter
        ButtonB11_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB12_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB12.MouseEnter
        ButtonB12_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB21_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB21.MouseEnter
        ButtonB21_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB22_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB22.MouseEnter
        ButtonB22_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB23_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB23.MouseEnter
        ButtonB23_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB31_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB31.MouseEnter
        ButtonB31_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB32_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB32.MouseEnter
        ButtonB32_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB33_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB33.MouseEnter
        ButtonB33_Rectangle_.Opacity = 1
    End Sub
    ...
    Private Sub ButtonB34_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonB34.MouseEnter
        ButtonB34_Rectangle_.Opacity = 1
    End Sub
