Class MainWindow
    ...
    Private Sub 标题_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs) Handles 标题.MouseLeftButtonDown
        NEXUS_Tools_ShutdownTimer.Opacity = 0.85
        NEXUS_Tools_ShutdownTimer.DragMove()
        NEXUS_Tools_ShutdownTimer.Opacity = 1
    End Sub

    Private Sub NEXUS_Tips_Version_MouseEnter(sender As Object, e As MouseEventArgs) Handles NEXUS_Tools_ShutdownTimer.MouseEnter
    ...
    Private Sub NEXUS_Tips_Version_MouseLeave(sender As Object, e As MouseEventArgs) Handles NEXUS_Tools_ShutdownTimer.MouseLeave
    ...
    Private Sub Button_确定_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button_确定.MouseDown
        子函数_定时关机("执行")
        开关_开.Visibility = Windows.Visibility.Visible
        开关_关.Visibility = Windows.Visibility.Hidden
    End Sub
