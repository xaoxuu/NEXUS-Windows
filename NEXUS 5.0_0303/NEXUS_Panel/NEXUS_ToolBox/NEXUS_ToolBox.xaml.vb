Class MainWindow
    ...
    Private Sub MainWindow_Initialized(sender As Object, e As EventArgs) Handles Me.Initialized
        Fun_Shell("C:\Program Files\NEXUS\Window.Panel\VBSSource\NEXUS_ToolBox_Open.vbs")
    ...
    Private Sub Button14_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button14.MouseEnter
        Button14.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub
    ...
    Private Sub Button15_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button15.MouseEnter
        Button15.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub
    ...
    Private Sub Button57_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button57.MouseEnter
        Button57.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub
    ...
    Private Sub Button58_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button58.MouseEnter
        Button58.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub
    ...
    Private Sub Button59_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button59.MouseEnter
        Button59.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub
    ...
    Private Sub Button65_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button65.MouseEnter
        Button65.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub
    ...
    End Sub
    Private Sub Button66_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button66.MouseDown

    End Sub

    Private Sub Button66_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button66.MouseEnter
        Button66.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub

    Private Sub Button66_MouseLeave(sender As Object, e As MouseEventArgs) Handles Button66.MouseLeave
        Button66.Fill = New SolidColorBrush(Color.FromArgb(0, 0, 0, 0))
    End Sub
    Private Sub Button67_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button67.MouseDown

    End Sub

    Private Sub Button67_MouseEnter(sender As Object, e As MouseEventArgs) Handles Button67.MouseEnter
        Button67.Fill = New SolidColorBrush(Color.FromArgb(15, 0, 0, 0))
    End Sub

    Private Sub Button67_MouseLeave(sender As Object, e As MouseEventArgs) Handles Button67.MouseLeave
        Button67.Fill = New SolidColorBrush(Color.FromArgb(0, 0, 0, 0))
    End Sub
