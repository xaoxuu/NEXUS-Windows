Class MainWindow
    ...
    Private Sub MainWindow_Initialized(sender As Object, e As EventArgs) Handles Me.Initialized
        ...
        Fun_Shell("C:\Program Files\NEXUS\Window.Panel\VBS\NEXUS_SettingCenter_Open.vbs")
    ...
    Private Sub 按钮_路径2_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles 按钮_路径2.MouseDown
        Fun_Shell("C:\Program Files\NEXUS\Install\VBS\StartupFolder.vbs")
