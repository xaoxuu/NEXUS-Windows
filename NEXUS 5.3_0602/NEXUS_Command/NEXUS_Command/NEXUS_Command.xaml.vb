Class MainWindow
    ...
    Private Sub Button_Expand_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button_Expand.MouseDown
        If Dir("D:\Program Files\NEXUS\Temp\NEXUS_Panel.dll") = "" Then
            ...
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Panel\VBS\NEXUS_Panel_Open.vbs" & Chr(34))
        Else
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Panel\VBS\NEXUS_Panel_Close.vbs" & Chr(34))
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Panel\VBS\ClosePanel.vbs" & Chr(34))
        End If
    End Sub
    '↑↑↑Expand按钮
    ...
    Private Sub Input_TextChanged(sender As Object, e As TextChangedEventArgs) Handles Input.TextChanged
        ...
        ElseIf Inputs = "游戏管家" Or Inputs = "精灵游戏管家" Then 'help
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Expand\NEXUS_Expand_XLauncher.exe" & Chr(34))
            Fun_Clear()
        ElseIf Inputs = "考研助手" Or Inputs = "精灵考研助手" Then 'help
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Expand\NEXUS_Expand_GREAssistant.exe" & Chr(34))
            Fun_Clear()
        ElseIf Inputs = "软件助手" Or Inputs = "精灵软件助手" Then 'help
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Expand\NEXUS_Expand_SoftwareAssistant.exe" & Chr(34))
            Fun_Clear()
        ...
        ElseIf Inputs = "ssssssssss" Then
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Main\VBS\shutdown-s.vbs" & Chr(34))
            End
        ElseIf Inputs = "hhhhhhhhhh" Then
            Address = ("shutdown -h")
            Fun_Run(Address)
        ElseIf Inputs = "llllllllll" Then
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Main\VBS\shutdown-l.vbs" & Chr(34))
            End
        ElseIf Inputs = "rrrrrrrrrr" Then
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Main\VBS\shutdown-r.vbs" & Chr(34))
            End
            '■■■■■■■■■■■■■■■■■■■■■■■■■■■学生周边
