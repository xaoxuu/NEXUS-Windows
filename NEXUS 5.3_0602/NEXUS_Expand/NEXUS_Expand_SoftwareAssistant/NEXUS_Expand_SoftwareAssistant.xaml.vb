Class MainWindow
    ...
    Private Sub MainWindow_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Expand\VBS\NEXUS_Expand_SoftwareAssistant_Close.vbs" & Chr(34))
    ...
    Private Sub Tab(i As UInteger)
        ...
        If i = 1 Then
            ...
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Expand\VBS\NEXUS_Office_Open.vbs" & Chr(34))
        ...
        ElseIf i = 2 Then
            ...
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Expand\VBS\NEXUS_Adobe_Open.vbs" & Chr(34))
        ...
        ElseIf i = 3 Then
            ...
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Expand\VBS\NEXUS_Corel_Open.vbs" & Chr(34))
    ...
    Private Sub Button145_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button145.MouseDown
        ...
        WshShell.run(Chr(34) & "http://url.cn/ZHkrNE " & Chr(34))
    End Sub
    ...
    Private Sub Button221_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button221.MouseDown
        ...
        If Dir("D:\Program Files\NEXUS\ToolBox\Adobe CS6 全系列通用破解补丁\Adobe_Photoshop_CS6安装激活教程.mht") = "" Then
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Tips\NEXUS_Tips_Error.exe" & Chr(34))
        Else
            WshShell.run(Chr(34) & "D:\Program Files\NEXUS\ToolBox\Adobe CC 全系列通用破解补丁\Adobe_Photoshop_CC安装激活教程.mht" & Chr(34))
            WshShell.run(Chr(34) & "D:\Program Files\NEXUS\ToolBox\Adobe CS6 全系列通用破解补丁\Adobe_Photoshop_CS6安装激活教程.mht" & Chr(34))
        End If
    ...
    Private Sub Button223_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button223.MouseDown
        If Dir("D:\Program Files\NEXUS\ToolBox\Adobe CS6 全系列通用破解补丁\激活工具\x86\amtlib.dll") = "" Then
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Tips\NEXUS_Tips_Error.exe" & Chr(34))
        Else

            WshShell.run(Chr(34) & "D:\Program Files\NEXUS\ToolBox\Adobe CS6 全系列通用破解补丁\激活工具\" & Chr(34))
            WshShell.run(Chr(34) & "D:\Program Files\NEXUS\ToolBox\Adobe CC 全系列通用破解补丁\激活工具\" & Chr(34))
    ...
    Private Sub Button322_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button322.MouseDown
        ...
        If Dir("D:\Program Files\NEXUS\ToolBox\会声会影\会声会影激活教程.mht") = "" Then
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Tips\NEXUS_Tips_Error.exe" & Chr(34))
        Else
            WshShell.run(Chr(34) & "D:\Program Files\NEXUS\ToolBox\会声会影\会声会影激活教程.mht" & Chr(34))

        End If
    End Sub
    Private Sub Button323_MouseDown(sender As Object, e As MouseButtonEventArgs) Handles Button323.MouseDown
        If Dir("D:\Program Files\NEXUS\ToolBox\会声会影\Corel激活.exe") = "" Then
            WshShell.run(Chr(34) & "C:\Program Files\NEXUS\Window.Tips\NEXUS_Tips_Error.exe" & Chr(34))
        Else
            WshShell.run(Chr(34) & "D:\Program Files\NEXUS\ToolBox\会声会影\Corel激活.exe" & Chr(34))
