Class MainWindow
    ...
    End Sub
    Private Sub ButtonA1_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonA1.MouseEnter
        Fun_MainTips(1)
        Fun_Color("a1")
    End Sub

    Private Sub ButtonA1_MouseLeave(sender As Object, e As MouseEventArgs) Handles ButtonA1.MouseLeave
        Fun_Color("1")
        Fun_MainTips(0)
    End Sub
    ...
    Private Sub ButtonA2_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonA2.MouseEnter

        Fun_MainTips(2)
        Fun_Color("a2")
    End Sub
    Private Sub ButtonA2_MouseLeave(sender As Object, e As MouseEventArgs) Handles ButtonA2.MouseLeave
        Fun_Color("1")
        Fun_MainTips(0)
    End Sub
    ...
    Private Sub ButtonA3_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonA3.MouseEnter

        Fun_MainTips(3)
        Fun_Color("a3")
    End Sub
    Private Sub ButtonA3_MouseLeave(sender As Object, e As MouseEventArgs) Handles ButtonA3.MouseLeave
        Fun_Color("1")
        Fun_MainTips(0)
    End Sub
    ...
    Private Sub ButtonA4_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonA4.MouseEnter

        Fun_MainTips(4)
        Fun_Color("a4")
    End Sub
    Private Sub ButtonA4_MouseLeave(sender As Object, e As MouseEventArgs) Handles ButtonA4.MouseLeave
        Fun_Color("1")
        Fun_MainTips(0)
    End Sub
    ...
    Private Sub ButtonA5_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonA5.MouseEnter

        Fun_MainTips(5)
        Fun_Color("a5")
    End Sub
    Private Sub ButtonA5_MouseLeave(sender As Object, e As MouseEventArgs) Handles ButtonA5.MouseLeave
        Fun_Color("1")
        Fun_MainTips(0)
    End Sub
    ...
    Private Sub ButtonA6_MouseEnter(sender As Object, e As MouseEventArgs) Handles ButtonA6.MouseEnter

        Fun_MainTips(6)
        Fun_Color("a6")
    End Sub
    Private Sub ButtonA6_MouseLeave(sender As Object, e As MouseEventArgs) Handles ButtonA6.MouseLeave
        Fun_Color("1")
        Fun_MainTips(0)
    End Sub
